<?php
$query = mysqli_query($conn, "SELECT pkwtdescriptions,
                                        pkwtheader
                                FROM table_datapkwt_h");
...
?>
<section>
    <h3 class="p-3" style="font-weight: bold;"><?= $h['pkwtheader'] ?></h3>
    <hr class="w-50">
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active p-3" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
            <p style="text-align: justify;"><?= $h['pkwtdescriptions'] ?></p>
        </div>
