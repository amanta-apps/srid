...
$lksdescriptions = $lksheader  = null;
        ...
        <div class="col-sm-8">
            ...
            <div class="form-group row mb-1">
                <fieldset class="border rounded p-2 mb-3">
                    <div class="form-group row mb-1">
                        <label for="headmdlks" class="col-sm-2">Header</label>
                        <div class="col-sm-10">
                    ...
                    <div id="editorlkshead"><?= $lksdescriptions ?></div>
                </fieldset>
            </div>
        </div>
        <div class="col-sm-4">
            ...
            <fieldset class="border rounded p-2 mb-3">
                ...
                <div class=" form-group row mt-3">
                    <div class="col-sm-12 text-end">
                        ...
                        <button type="button" class="btn btn-sm btn-success zoom" onclick="submitmdlks()"><img src="../assets/icon/save.png"> Simpan</button>
                    </div>
                </div>
            </fieldset>
        </div>
...
<script>
    let editorInstance;
    ClassicEditor
        .create(document.getElementById('editorlkshead'), {
