...
?>
<div class="container">
    <h3 class="fw-bold">Realisasi Pembagian Parcel #<?= $parcelid ?></h3>
    <hr class="mb-5">
    <div class="row">
        <div class="col-sm-8">
            <fieldset class="border rounded p-2 mb-3">
                ...
                <div class="form-group row mb-1" hidden>
                    <label for="parcelidmdparcelreal" class="col-sm-2 text-end">Id Parcel</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control form-control-sm" id="parcelidmdparcelreal" value="<?= $parcelid ?>" readonly>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            while ($r = mysqli_fetch_array($query)) { ?>
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control form-control-sm total-output-parcel" id="qtymdparcelreal<?= $i ?>" min="0" value="<?= $r['realqty'] ?>" onchange="gettotalparcelreal()"></td>
                                </tr>
                            <?php
                                $i += 1;
                            }
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control form-control-sm fw-bold fs-5" id="totalqtymdparcelreal" value="<?= $totalranc ?>" readonly></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <fieldset class="border rounded p-2">
                    ...
                    <div class="form-group row mb-3">
                        <label for="tglrancanganfrommdparcelreal" class="col-sm-2">Tgl Rancangan</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control form-control-sm" id="tglrancanganfrommdparcelreal" value="<?= $tglfrom ?>" readonly>
                        </div>
                        <label for="tglrancangantomdparcelreal" class="col-sm-1 text-center">Sampai</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control form-control-sm" id="tglrancangantomdparcelreal" value="<?= $tglto ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label for="tglrealisaimdparcelreal" class="col-sm-2">Tgl Realisasi</label>
                        <div class="col-sm-2">
                            <input type="date" class="form-control form-control-sm" id="tglrealisaimdparcelreal" value="<?= date('Y-m-d') ?>">
                        </div>
                    </div>
                    <div id="editorparcelreal"></div>
                </fieldset>
            </fieldset>
        ...
        <div class="col-sm-4">
            <fieldset class="border rounded p-2 mb-3">
                ...
                <div class="form-group row mb-1">
                    <label for="createdonmdparcelreal" class="col-sm-6">Created On</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control form-control-sm" id="createdonmdparcelreal" value="<?= beautydate1($createdon) ?>" readonly>
                    </div>
                </div>
                <div class="form-group row mb-1">
                    <label for="createdbymdparcelreal" class="col-sm-6">Created By</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control form-control-sm" id="createdbymdparcelreal" value="<?= $createdby ?>" readonly>
                    </div>
                </div>
                <div class="form-group row mb-1">
                    <label for="statusmdparcelreal" class="col-sm-6">Status</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control form-control-sm" id="statusmdparcelreal" value="<?= Getdata('stats', 'table_datastats', 'idstats', 3) ?>" readonly>
                    </div>
                </div>
            </fieldset>
            <fieldset class="border rounded p-2 mb-3">
                ...
                <div class=" form-group row mt-3">
                    <div class="col-sm-12 text-end">
                        ...
                        <button type="button" class="btn btn-sm btn-success zoom" onclick="submitmdparcelreal()"><img src="../assets/icon/save.png"> Simpan</button>
                    </div>
                </div>
            </fieldset>
        </div>
...
<script>
    let editorInstance;
    ClassicEditor
        .create(document.getElementById('editorparcelreal'), {
